...
import com.arthursouza.todosimple.models.User.CreateUser;
import com.arthursouza.todosimple.models.User.UpdateUser;
...
public class UserController {
    ...
    public ResponseEntity<Void> create(@Valid @RequestBody User obj){
        ...
        /* Gets the current path (/user/) and adds current ID */
